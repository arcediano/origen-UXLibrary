 ...
 * @description Pull-to-refresh gesture para móvil con Framer Motion.
 *              Arrastra desde la parte superior hacia abajo para disparar refresh.
 *              Animación con indicador rotativo y resistencia táctil nativa.
 *
 * Tokens Origen v3.0. Dependencias: framer-motion, lucide-react.
 */
