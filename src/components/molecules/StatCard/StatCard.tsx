 ...
 * Tarjeta KPI reutilizable con icono, label, valor, tendencia y subtexto.
 *
 * @example
 * <StatCard
...
export interface StatCardTrend {
  /** Porcentaje de cambio. Positivo = sube, negativo = baja, 0 = neutral */
  value: number;
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2 mb-2">
        {icon && (
          <span
            className={cn("flex-shrink-0 [&>svg]:h-4 [&>svg]:w-4", colors.icon)}
            aria-hidden
          >
            {icon}
          </span>
