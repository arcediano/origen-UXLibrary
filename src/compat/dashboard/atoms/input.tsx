  ...
  (
    ...
    const variantClasses = {
      default: cn(
        ...
        error && "border-feedback-danger hover:border-red-600",
    ...
    const getProgressColor = () => {
      ...
      if (charCount === maxLength) return "bg-feedback-danger";
        ...
        <div className="relative">
          ...
          <div className={cn(
            ...
            {validationState === "error" && !isPassword && (
              <AlertCircle className={cn(getIconSize(), "text-feedback-danger")} />
            )}
